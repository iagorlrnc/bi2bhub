  ...
  return (
    <div className="space-y-6" onDragEnter={handleDrag}>
      ...
      {selectedCompanyId ? (
        ...
        <div className="flex flex-col items-center justify-center text-center p-16 border border-dashed border-[hsl(var(--border))] rounded-2xl bg-[hsl(var(--card))]/40 shadow-inner">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-500/10 text-brand-500 mb-4 shadow-sm">
