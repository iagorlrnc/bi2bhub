...
export function PortalHeroSection({ isDark }: PortalHeroSectionProps) {
  ...
  return (
    <section className="relative min-h-[calc(100vh-3rem)] flex flex-col items-center justify-center py-16 px-4 sm:px-6 md:px-8 overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col items-center justify-center text-center my-auto w-full">
        {/* Top Badge Estático */}
        <div
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-[#0d6084] dark:text-cyan-300 font-extrabold text-xs uppercase tracking-widest shadow-sm mb-6"
        >
        ...
        <h1
          className={cn(
            'text-[2.4rem] sm:text-[3.4rem] md:text-[4.2rem] lg:text-[4.8rem] font-black leading-[1.1] tracking-tight font-sans text-balance max-w-4xl',
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-[#0d6084] to-[#0a4a62] hover:from-[#0f6f99] hover:to-[#0c5874] border border-cyan-400/30 text-white font-extrabold text-xs sm:text-sm uppercase tracking-wider px-8 py-4 rounded-full shadow-md cursor-pointer"
          >
          ...
          <button
            ...
            className={cn(
              'w-full sm:w-auto inline-flex items-center justify-center gap-2.5 font-extrabold text-xs sm:text-sm uppercase tracking-wider px-8 py-4 rounded-full border cursor-pointer shadow-sm',
              isDark
