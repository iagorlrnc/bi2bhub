...
export function PortalHeroSection({ isDark }: PortalHeroSectionProps) {
  ...
  return (
    <section className="relative min-h-[85vh] flex flex-col justify-center items-center py-20 px-4 sm:px-6 md:px-8 overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center justify-center text-center my-auto w-full">
        ...
        >
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#0d6084] to-[#0a4a62] hover:from-[#0f6f99] hover:to-[#0c5874] border border-cyan-400/40 text-white font-extrabold text-xs sm:text-sm uppercase tracking-wider px-8 py-4 rounded-full shadow-[0_10px_35px_rgba(13,96,132,0.4)] hover:shadow-[0_15px_45px_rgba(13,96,132,0.6)] hover:-translate-y-0.5 transition-all duration-300 active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className={cn(
              'w-full sm:w-auto inline-flex items-center justify-center gap-2 font-bold text-xs sm:text-sm uppercase tracking-wider px-8 py-4 rounded-full border transition-all duration-300 cursor-pointer',
              isDarkTheme
