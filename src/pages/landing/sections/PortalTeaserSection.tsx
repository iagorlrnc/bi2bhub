...
export function PortalTeaserSection({ isDark }: PortalTeaserSectionProps) {
  ...
  const highlights = [
    {
      ...
      desc: 'Visão clara dos seus indicadores, faturamento e tributos em tempo real.',
    },
    {
      icon: Receipt,
      title: 'Guias e Impostos sem Atrasos',
      desc: 'Notificação automática de guias com cálculo rápido e histórico de pagamentos.',
    },
    {
      icon: FileCheck2,
      title: 'Drive Cloud de Documentos',
      desc: 'Acesso instantâneo a contratos, certidões CND e balancetes 24h por dia.',
    },
    {
      icon: MessageSquareCheck,
      title: 'Chamados e Suporte Direto',
      desc: 'Canal estruturado para falar direto com seu contador especialista sem burocracia.',
    },
  ]
  ...
  return (
    <section id="portal-teaser" className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div
        className={cn(
          'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[450px] rounded-full blur-[180px] pointer-events-none -z-10',
          isDark ? 'bg-gradient-to-tr from-[#0d6084]/25 via-cyan-500/20 to-transparent' : 'bg-gradient-to-tr from-[#0d6084]/15 via-cyan-400/20 to-transparent'
        )}
      />
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className={cn(
            'relative rounded-3xl p-8 sm:p-12 md:p-16 border overflow-hidden shadow-2xl backdrop-blur-xl',
            isDark
        ...
        >
          {/* Subtle Corner Badge */}
          <div className="absolute top-6 right-6 hidden sm:flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-500 dark:text-cyan-300 text-xs font-bold uppercase tracking-widest">
            <Sparkles className="w-3.5 h-3.5" />
            Exclusivo para Clientes Bi2B
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Left Content */}
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-cyan-400/30 bg-cyan-500/10 text-[#0d6084] dark:text-cyan-300 font-bold text-xs uppercase tracking-widest">
                ...
                {highlights.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={cn(
                        'p-4 rounded-2xl border transition-all duration-300 flex items-start gap-3.5',
                        isDark
                          ? 'bg-white/5 border-white/10 hover:border-cyan-400/30'
                          : 'bg-white/80 border-slate-200 hover:border-[#0d6084]/30'
                      )}
                    >
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#0d6084] via-[#0f729d] to-cyan-500 hover:from-[#0f6f99] hover:to-cyan-400 text-white font-extrabold text-sm uppercase tracking-wider px-8 py-4 rounded-full shadow-[0_10px_35px_rgba(13,96,132,0.45)] hover:shadow-[0_15px_45px_rgba(13,96,132,0.6)] hover:-translate-y-1 transition-all duration-300 cursor-pointer active:scale-95 group"
                >
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div
                className={cn(
                  'w-full max-w-md rounded-2xl p-6 border shadow-2xl space-y-4 backdrop-blur-md transform rotate-1 hover:rotate-0 transition-transform duration-500',
                  isDark
