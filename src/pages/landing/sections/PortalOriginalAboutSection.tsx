...
interface PortalOriginalAboutSectionProps {
  isDark?: boolean
}
...
export function PortalOriginalAboutSection({ isDark }: PortalOriginalAboutSectionProps) {
  return (
    <section id="sobre-original" className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isDark
                      ? 'bg-[#060e20] border-white/10 shadow-lg shadow-cyan-950/20'
