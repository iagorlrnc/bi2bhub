...
export function Bi2BPortalModulesSection() {
  ...
  return (
    <section id="modulos" className="bi2b-section bi2b-on-light border-t border-[#0B4F6C]/10 relative overflow-hidden">
      ...
      <div className="bi2b-wrap relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0B4F6C]/10 border border-[#0B4F6C]/20 text-[#0B4F6C] font-mono text-[0.72rem] font-semibold tracking-widest uppercase mb-3.5">
            ...
            <span>Módulos &amp; Ferramentas da Plataforma</span>
          </div>
          ...
          <p className="bi2b-lead text-base sm:text-lg text-[#59707B] max-w-[54ch] mx-auto">
            Cada cliente Bi2B tem acesso a uma plataforma corporativa completa para gerenciar guias, documentos e finanças sem fricção.
          </p>
        </div>

        {/* Feature Tabs Selector */}
        <div className="flex flex-wrap items-center justify-center gap-2 mb-10 bi2b-reveal in">
        ...
        <div className="bg-white border border-[#0B4F6C]/15 rounded-[22px] p-6 sm:p-10 lg:p-12 shadow-[0_20px_60px_-25px_rgba(11,79,108,0.25)] bi2b-reveal in">
          ...
          <div className="mt-10 pt-8 border-t border-[#0B4F6C]/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-xs sm:text-sm text-[#59707B] text-center sm:text-left">
              ...
              <span>Ambiente corporativo disponível 24 horas por dia, 7 dias por semana.</span>
            </div>
            ...
            >
              <span>Acessar o Portal Agora</span>
