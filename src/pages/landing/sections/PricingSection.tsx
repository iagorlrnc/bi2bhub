...
const plans = [
  {
    ...
    isSpecialist: false,
    features: [
      'Guias Bi2B (XML Automático SEFAZ)',
      'Monitora Bi2B (CND Federal)',
      'Bi2B Drive de 5GB',
  ...
  {
    name: 'Pró',
    desc: 'Recomendado para empresas e equipes que buscam controle fiscal automatizado.',
    monthly: '247',
    yearly: '185',
    ...
    isSpecialist: false,
    features: [
      'Guias Bi2B (Sincronização em Lote)',
      'Monitora Bi2B Completo (Federal, Estadual, Municipal)',
      'Bi2B Drive de 20GB',
      'Bi2B Chamados (Atendimento Prioritário)',
      'Tarefas Bi2B (Gestão Visual de Impostos)',
    ],
    pop: true,
  },
  {
    name: 'Corporativo / Plus',
    desc: 'Para holdings, grupos empresariais e operações com demandas customizadas.',
    ...
    isSpecialist: true,
    features: [
      'Guias Bi2B & Monitora sem limites de emissão',
      'API de Integração Contábil Dedicada',
      'Bi2B Drive de 100GB Criptografado',
      'Gerente de Conta & Suporte 24/7',
      'Auditoria de Logs e LGPD Avançada',
    ],
  },
]
